...
export const faqs: Faq[] = [
  ...
  { topic: "tempi", q: "Quanto tempo serve per rifare un bagno?", a: "Una ristrutturazione completa richiede in media 7-12 giorni lavorativi di cantiere. A questi vanno aggiunte 2-4 settimane precedenti per sopralluogo, progetto, preventivo e consegna dei materiali." },
  ...
  { topic: "area", q: "In quali zone operate?", a: "Bagni Milano opera a Milano e nella Città metropolitana, a Monza e in Brianza, a Lodi, Bergamo, Varese e Como con le rispettive province, e più in generale in Lombardia. Per le restanti province lombarde la copertura viene confermata al primo contatto." },
  ...
  { topic: "area", q: "Operate a Bergamo, Varese e Como?", a: "Sì. Bergamo, Varese e Como rientrano nelle province servite in modo continuativo, insieme a Milano, Monza e Brianza e Lodi. Per i comuni più distanti confermiamo la copertura al primo contatto." },
