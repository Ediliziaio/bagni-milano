...
export const images: ImageSpec[] = [
  ...
  { id: "showroom", where: "Home e contatti", brief: "Showroom o area di consulenza con i campioni esposti.", width: 1600, height: 1067, alt: "Area di consulenza di Bagni Milano con i campioni dei materiali", priority: 3, available: true, source: "riferimento" },
  ...
  { id: "art-quanto-costa-rifare-un-bagno", where: "Articolo /blog/quanto-costa-rifare-un-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Preventivo di ristrutturazione bagno con campioni di gres e calcolatrice", priority: 2, available: true, source: "riferimento" },
  { id: "art-costo-piastrelle-bagno", where: "Articolo /blog/costo-piastrelle-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Campioni di gres porcellanato di formati diversi per il rivestimento del bagno", priority: 2, available: true, source: "riferimento" },
  { id: "art-quanto-costa-trasformare-vasca-in-doccia", where: "Articolo /blog/quanto-costa-trasformare-vasca-in-doccia", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Vasca rimossa in cantiere con lo scarico in vista prima della trasformazione in doccia", priority: 2, available: true, source: "riferimento" },
  { id: "art-costo-bagno-6-mq", where: "Articolo /blog/costo-bagno-6-mq", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Bagno di 6 mq ristrutturato, vista d'insieme dall'ingresso", priority: 2, available: true, source: "riferimento" },
  { id: "art-costo-manodopera-ristrutturazione-bagno", where: "Articolo /blog/costo-manodopera-ristrutturazione-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Posatore al lavoro sul rivestimento di un bagno in ristrutturazione", priority: 2, available: true, source: "riferimento" },
  { id: "art-leggere-preventivo-ristrutturazione-bagno", where: "Articolo /blog/leggere-preventivo-ristrutturazione-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Preventivo dettagliato di ristrutturazione bagno aperto su una scrivania", priority: 2, available: true, source: "riferimento" },
  { id: "art-come-progettare-un-bagno", where: "Articolo /blog/come-progettare-un-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Pianta quotata di un bagno con la disposizione dei sanitari", priority: 2, available: true, source: "riferimento" },
  { id: "art-dimensioni-minime-bagno", where: "Articolo /blog/dimensioni-minime-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Rilievo delle misure di un bagno piccolo con metro laser", priority: 2, available: true, source: "riferimento" },
  { id: "art-errori-da-evitare-ristrutturazione-bagno", where: "Articolo /blog/errori-da-evitare-ristrutturazione-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Difetti di posa in un bagno: fughe irregolari e siliconatura mal eseguita", priority: 2, available: true, source: "riferimento" },
  { id: "art-gres-o-ceramica-per-il-bagno", where: "Articolo /blog/gres-o-ceramica-per-il-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Confronto fra un campione di gres porcellanato e uno di ceramica smaltata", priority: 2, available: true, source: "riferimento" },
  { id: "art-impermeabilizzazione-bagno", where: "Articolo /blog/impermeabilizzazione-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Impermeabilizzazione con guaina liquida della zona doccia prima della posa", priority: 2, available: true, source: "riferimento" },
  { id: "art-sanitari-sospesi", where: "Articolo /blog/sanitari-sospesi", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Telaio per sanitari sospesi installato prima della controparete", priority: 2, available: true, source: "riferimento" },
  { id: "art-muffa-in-bagno-cause-e-soluzioni", where: "Articolo /blog/muffa-in-bagno-cause-e-soluzioni", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Muffa nera nell'angolo alto di un bagno, sulla fuga e sull'intonaco", priority: 2, available: true, source: "riferimento" },
  { id: "art-infiltrazioni-dal-bagno", where: "Articolo /blog/infiltrazioni-dal-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Macchia di infiltrazione sul soffitto dell'appartamento sottostante un bagno", priority: 2, available: true, source: "riferimento" },
  { id: "art-cattivi-odori-in-bagno", where: "Articolo /blog/cattivi-odori-in-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Sifone del lavabo smontato per la pulizia sotto il mobile del bagno", priority: 2, available: true, source: "riferimento" },
  { id: "art-scarico-bagno-lento", where: "Articolo /blog/scarico-bagno-lento", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Acqua che ristagna sul piatto doccia per scarico lento", priority: 2, available: true, source: "riferimento" },
  { id: "art-poca-pressione-acqua-bagno", where: "Articolo /blog/poca-pressione-acqua-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Soffione doccia con getto debole per ugelli otturati dal calcare", priority: 2, available: true, source: "riferimento" },
  { id: "art-serve-la-cila-per-rifare-il-bagno", where: "Articolo /blog/serve-la-cila-per-rifare-il-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Planimetria e modulistica per la comunicazione dei lavori", priority: 2, available: true, source: "riferimento" },
  { id: "art-detrazioni-ristrutturazione-bagno", where: "Articolo /blog/detrazioni-ristrutturazione-bagno", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Documenti fiscali e ricevute per la detrazione dei lavori di ristrutturazione", priority: 2, available: true, source: "riferimento" },
  { id: "art-ristrutturare-bagno-a-milano", where: "Articolo /blog/ristrutturare-bagno-a-milano", brief: "Testata dell'articolo.", width: 1600, height: 900, alt: "Cortile interno di un condominio milanese degli anni Sessanta", priority: 2, available: true, source: "riferimento" },
  { id: "pag-ristrutturazione-bagno", where: "Pillar /ristrutturazione-bagno — apertura", brief: "Immagine di sezione.", width: 1600, height: 900, alt: "Bagno ristrutturato chiavi in mano da Bagni Milano, vista d'insieme", priority: 1, available: true, source: "riferimento" },
  { id: "pag-metodo", where: "Pagina /metodo — apertura", brief: "Immagine di sezione.", width: 1600, height: 900, alt: "Tavolo di progetto con planimetria, campioni e cronoprogramma", priority: 1, available: true, source: "riferimento" },
  { id: "pag-servizi", where: "Pagina /servizi — apertura", brief: "Immagine di sezione.", width: 1600, height: 900, alt: "I servizi di ristrutturazione bagno di Bagni Milano", priority: 1, available: true, source: "riferimento" },
  { id: "lav-massetto", where: "Pillar — fascia lavorazioni", brief: "Immagine di sezione.", width: 1600, height: 1067, alt: "Massetto autolivellante steso sul pavimento di un bagno in ristrutturazione", priority: 1, available: true, source: "riferimento" },
  { id: "lav-posa", where: "Pillar — fascia lavorazioni", brief: "Immagine di sezione.", width: 1600, height: 1067, alt: "Posa del pavimento in gres di grande formato in un bagno", priority: 1, available: true, source: "riferimento" },
  { id: "fase-progetto", where: "Metodo — macro-fase Progetto", brief: "Immagine di sezione.", width: 1600, height: 1067, alt: "Sopralluogo tecnico in un bagno da ristrutturare", priority: 1, available: true, source: "riferimento" },
  { id: "fase-materiali", where: "Metodo — macro-fase Preventivo e materiali", brief: "Immagine di sezione.", width: 1600, height: 1067, alt: "Campioni di materiali selezionati per un progetto di ristrutturazione bagno", priority: 1, available: true, source: "riferimento" },
  { id: "fase-consegna", where: "Metodo — macro-fase Consegna", brief: "Immagine di sezione.", width: 1600, height: 1067, alt: "Bagno finito il giorno della consegna, con la documentazione sul mobile", priority: 1, available: true, source: "riferimento" },

  { id: "og-social", where: "Anteprima social (Open Graph)", brief: "Una delle foto migliori, ritagliata 1200×630 con spazio per il testo.", width: 1200, height: 630, alt: "Bagni Milano — ristrutturazione bagno chiavi in mano", priority: 2, available: true, source: "riferimento" },
];
