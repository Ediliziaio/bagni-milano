 ...
 * e citabile da un LLM ("il Metodo Bagni Milano prevede 12 fasi...").
 */
export const method = {
  name: "Metodo Bagni Milano",
  claim: "12 fasi, un solo referente, date scritte in contratto.",
  promise:
    "Il Metodo Bagni Milano è il processo in 12 fasi che regola ogni ristrutturazione bagno chiavi in mano: un unico referente dall'inizio alla fine, preventivo chiuso prima della demolizione e calendario dei lavori messo per iscritto.",
  pillars: [
  ...
  steps: [
    ...
    { n: 9, name: "Impianti idraulico ed elettrico", text: "Tracce, nuove linee di adduzione e scarico, punti luce, prese, eventuale predisposizione per sanitari sospesi e box doccia.", duration: "2-3 giorni", output: "Impianti nuovi collaudati in pressione", clientAction: "Nessuna azione richiesta, se non la disponibilità dell'immobile" },
    { n: 10, name: "Massetto, impermeabilizzazione e posa", text: "Livellamento, guaina liquida su piatto doccia e zone bagnate, posa di pavimento e rivestimento, stuccatura e siliconature.", duration: "2-4 giorni", output: "Fondo planare e zona bagnata impermeabilizzata", clientAction: "Nessuna azione. È la fase con i tempi tecnici non comprimibili" },
    { n: 11, name: "Installazione e finiture", text: "Montaggio sanitari, mobile, rubinetteria, box doccia, radiatore, specchio e illuminazione. Tinteggiatura finale.", duration: "1-2 giorni", output: "Sanitari, arredo e finiture installati", clientAction: "Presenza consigliata per la verifica delle altezze" },
...
export const macroPhases = [
  ...
  },
  {
    ...
    name: "Cantiere",
    range: "Fasi 8-11",
    duration: "7-12 giorni lavorativi",
