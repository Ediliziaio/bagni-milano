...
export const MobileCtaBar = () => (
  <div className="fixed inset-x-0 bottom-0 z-40 border-t border-line-dark bg-ink/95 backdrop-blur md:hidden">
    <div className="grid grid-cols-3 gap-2 p-2.5">
      <a href={`tel:${site.telephoneE164}`} className="btn-outline-light !min-h-0 !py-3.5 !px-1.5 !text-[0.75rem]" data-cta="mobile-call">
      ...
      <a
        ...
        className="btn-outline-light !min-h-0 !py-3.5 !px-1.5 !text-[0.75rem]"
        data-cta="mobile-whatsapp"
      >
        <MessageCircle size={15} aria-hidden /> WhatsApp
      </a>
      <Link to="/preventivo" className="btn-gold !min-h-0 !py-3.5 !px-1.5 !text-[0.75rem]" data-cta="mobile-quote">
        Preventivo
      </Link>
    </div>
  </div>
